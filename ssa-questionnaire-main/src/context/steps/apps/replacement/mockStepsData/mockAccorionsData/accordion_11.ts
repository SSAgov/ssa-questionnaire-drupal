...
export const accordion_11: IAccordion = {
  id: '11',
  title: 'Marriage certificate',
  body: `
      <p>
        You must present an original marriage certificate or a copy certified by the agency that issued it. We cannot accept photocopies, photographs, or notarized copies.  
      </p>
      `,
  requirements: [

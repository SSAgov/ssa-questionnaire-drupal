...
export const accordion_10: IAccordion = {
  id: '10',
  title: `Correct parent's name`,
  body: `
      <p>
      ...
      <ul>
        <li>Birth certificate with the correct name</li>
        <li>Final adoption decree</li>
        <li>Court determination of paternity</li>
      </ul>
      `,
  requirements: [
    {
      ...
      changeQuestionAnswerBreakdown: (cqAnswer: string[]) =>
        changeQuestionAnswer(cqAnswer).includesParentsName,
    ...
    },
    {
      ...
      NDAnswerBreakdown: (ndAnswer: string[]) =>
        NDAnswerBreakdown(ndAnswer).includesParentsName,
    ...
    },
    {
      ...
      AAQuestionAnswerBreakdown: (aaAnswer: string[]) =>
        AAQuestionAnswer(aaAnswer).includesParentsName,
      responses: [
        ...CHILD_CITIZEN,
    ...
    },
    {
      ...
      NCQuestionAnswerBreakdown: (naAnswer: string[]) =>
        NCQuestionAnswer(naAnswer).includesParentsName,
      responses: [
        ...CHILD_NON_CITIZEN,
        { question: 'II', answers: [UNANSWERED, YES] },
        { question: 'C', answers: [YES] },

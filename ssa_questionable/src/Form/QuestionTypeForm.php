...
namespace Drupal\ssa_questionable\Form;
...
class QuestionTypeForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if ($this->operation == 'add') {
      $form['#title'] = $this->t('Add question type');
    }
    else {
      $form['#title'] = $this->t(
        'Edit %label question type',
    ...
    $form['machine_name'] = [
      ...
      '#machine_name' => [
        'exists' => [
          'Drupal\ssa_questionable\Entity\QuestionType',
          'load',
        ],
        'source' => ['label'],
      ],
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $entity_type->set('machine_name', trim($entity_type->id()));
    ...
    if ($status == SAVED_UPDATED) {
      $message = $this->t('The question type %name has been updated.', $t_args);
    }

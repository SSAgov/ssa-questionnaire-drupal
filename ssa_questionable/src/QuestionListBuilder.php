...
class QuestionListBuilder extends EntityListBuilder {
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total questions: @total', ['@total' => $total]);
    return $build;
  }
  ...
  public function buildHeader() {
    ...
    $header['id'] = $this->t('ID');
    $header['question_text'] = $this->t('Text');
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\ssa_questionable\QuestionInterface $entity */
    $row['type'] = $entity->bundle()->entity->label();
    $row['id'] = $entity->getQuestionId();
    $row['question_text'] = $entity->label();
